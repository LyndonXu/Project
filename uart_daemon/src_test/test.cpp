...
//#define ECHO_CNTL_TEST
//#define UART_TEST
//#define UART_TEST_LIB
//#define MSG_TEST
#define CMD_TEST

#if defined ECHO_CNTL_TEST
#include <unistd.h>
...
int open_port(int fd, int comport)
{
	...
	{
#if defined __arm__
		printf("himm 0x120F00F8 1, himm 0x120F00FC 1\n");
		system("himm 0x120F00F8 1");
		system("himm 0x120F00FC 1");
#endif
...
int main(int arc, char *argv[])
{
	...
	{
		uint8_t u8Buf[8] =
		{ 0xAA, 0x00, 0x0C, 0x80, 0x00, 0x00, 0x02, 0x24 };
		write(fd, u8Buf, 8);
		sleep(1);
	}
